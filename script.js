...
fetch('https://online-movie-database.p.rapidapi.com/auto-complete?q=thor', options)
    ...
    .then(response => {
        ...
        arrayMovies.map((elementos) => {
            //console.log(elementos)
            const titulo = elementos.l
            const imagen = elementos.i.imageUrl
            const actores = elementos.s 
            ...
            `
            document.getElementById("divPeliculas").innerHTML += poster
        })
    })
